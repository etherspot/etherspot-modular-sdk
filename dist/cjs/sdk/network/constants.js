...
exports.CHAIN_ID_TO_NETWORK_NAME = exports.DEFAULT_QUERY_PAGE_SIZE = exports.DEFAULT_MULTIPLE_OWNER_ECDSA_VALIDATOR_ADDRESS = exports.DEFAULT_BOOTSTRAP_ADDRESS = exports.DEFAULT_ERC20_SESSION_KEY_VALIDATOR_ADDRESS = exports.Networks = exports.NETWORK_NAME_TO_CHAIN_ID = exports.SupportedNetworks = exports.NetworkNames = void 0;
exports.getNetworkConfig = getNetworkConfig;
const tslib_1 = require("tslib");
const chains_1 = require("viem/chains");
const Chain = tslib_1.__importStar(require("viem/chains"));
...
exports.SupportedNetworks = [1, 10, 14, 30, 31, 50, 51, 56, 97, 100, 114, 122, 123, 137, 2357, 5000, 5003, 8453, 10200, 42161, 42220, 43113, 43114, 44787, 59140, 59144, 80002, 84532, 421614, 534351, 534352, 11155111, 11155420, 28122024, 79479957, 888888888];
...
exports.DEFAULT_ERC20_SESSION_KEY_VALIDATOR_ADDRESS = "0x22A55192a663591586241D42E603221eac49ed09";
exports.DEFAULT_BOOTSTRAP_ADDRESS = "0x0D5154d7751b6e2fDaa06F0cC9B400549394C8AA";
exports.DEFAULT_MULTIPLE_OWNER_ECDSA_VALIDATOR_ADDRESS = "0x0740Ed7c11b9da33d9C80Bd76b826e4E90CC1906";
exports.DEFAULT_QUERY_PAGE_SIZE = 50;
exports.CHAIN_ID_TO_NETWORK_NAME = Object.entries(exports.NETWORK_NAME_TO_CHAIN_ID).reduce((result, [networkName, chainId]) => ({
    ...result,
    [chainId]: networkName,
}), {});
function getNetworkConfig(key) {
    return exports.Networks[key];
}
