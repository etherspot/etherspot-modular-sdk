...
var network_name_to_chain_id_exports = {};
__export(network_name_to_chain_id_exports, {
  NETWORK_NAME_TO_CHAIN_ID: () => NETWORK_NAME_TO_CHAIN_ID,
  networkNameToChainId: () => networkNameToChainId
});
module.exports = __toCommonJS(network_name_to_chain_id_exports);
...
*/
//# sourceMappingURL=network-name-to-chain-id.cjs.map