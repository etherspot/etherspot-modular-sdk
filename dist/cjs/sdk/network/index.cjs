...
var NetworkNames = /* @__PURE__ */ ((NetworkNames5) => {
  NetworkNames5["BaseSepolia"] = "baseSepolia";
  NetworkNames5["Sepolia"] = "sepolia";
  NetworkNames5["Optimism"] = "optimism";
  NetworkNames5["Polygon"] = "polygon";
  NetworkNames5["Arbitrum"] = "arbitrum";
  NetworkNames5["ArbitrumSepolia"] = "arbitrumSepolia";
  NetworkNames5["Chiado"] = "chiado";
  NetworkNames5["Fuse"] = "fuse";
  NetworkNames5["FuseSparknet"] = "fuseSparknet";
  NetworkNames5["Gnosis"] = "gnosis";
  NetworkNames5["KromaTestnet"] = "kromaTestnet";
  NetworkNames5["Mainnet"] = "mainnet";
  NetworkNames5["OptimismSepolia"] = "optimismSepolia";
  NetworkNames5["Rootstock"] = "rootstock";
  NetworkNames5["RootstockTestnet"] = "rootstockTestnet";
  NetworkNames5["Mantle"] = "Mantle";
  NetworkNames5["MantleSepolia"] = "MantleSepolia";
  NetworkNames5["Avalanche"] = "avalanche";
  NetworkNames5["Base"] = "base";
  NetworkNames5["Bsc"] = "bsc";
  NetworkNames5["BscTestnet"] = "bscTestnet";
  NetworkNames5["Fuji"] = "fuji";
  NetworkNames5["Linea"] = "linea";
  NetworkNames5["LineaTestnet"] = "lineaTestnet";
  NetworkNames5["FlareTestnet"] = "flareTestnet";
  NetworkNames5["Flare"] = "flare";
  NetworkNames5["ScrollSepolia"] = "scrollSepolia";
  NetworkNames5["Scroll"] = "scroll";
  NetworkNames5["Ancient8Testnet"] = "ancient8Testnet";
  NetworkNames5["Ancient8"] = "ancient8";
  NetworkNames5["Amoy"] = "amoy";
  NetworkNames5["XDCTestnet"] = "xdcTestnet";
  NetworkNames5["XDCMainnet"] = "xdcMainnet";
  NetworkNames5["CeloTestnet"] = "celoTestnet";
  NetworkNames5["Celo"] = "celo";
  NetworkNames5["SxNetworkTestnet"] = "sxNetworkTestnet";
  return NetworkNames5;
})(NetworkNames || {});
