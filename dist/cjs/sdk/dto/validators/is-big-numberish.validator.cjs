...
var is_big_numberish_validator_exports = {};
__export(is_big_numberish_validator_exports, {
  IsBigNumberish: () => IsBigNumberish
});
module.exports = __toCommonJS(is_big_numberish_validator_exports);
...
//# sourceMappingURL=is-big-numberish.validator.cjs.map