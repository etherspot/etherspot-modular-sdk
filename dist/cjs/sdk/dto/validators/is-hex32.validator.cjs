...
var is_hex32_validator_exports = {};
__export(is_hex32_validator_exports, {
  IsHex32: () => IsHex32
});
module.exports = __toCommonJS(is_hex32_validator_exports);
...
function IsHex(options = {}, validationOptions = {}) {
  return (object, propertyName) => {
    ...
    if (size2 > 0) {
      message = `${message} with ${size2} size`;
    }
    (0, import_class_validator.registerDecorator)({
      ...
      validator: {
        validate(value) {
          let result = isHex2(value);
          if (result && size2 > 0) {
            result = value.length === size2 * 2 + 2;
          }
          return result;
        }
      }
...
*/
//# sourceMappingURL=is-hex32.validator.cjs.map