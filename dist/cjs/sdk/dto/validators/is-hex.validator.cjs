...
var is_hex_validator_exports = {};
__export(is_hex_validator_exports, {
  IsHex: () => IsHex
});
module.exports = __toCommonJS(is_hex_validator_exports);
...
*/
//# sourceMappingURL=is-hex.validator.cjs.map