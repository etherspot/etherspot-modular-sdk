...
var validate_dto_exports = {};
__export(validate_dto_exports, {
  validateDto: () => validateDto
});
module.exports = __toCommonJS(validate_dto_exports);
...
async function validateDto(dto, DtoConstructor, options = {}) {
  ...
  const errors = await (0, import_class_validator.validate)(result, {
...
*/
//# sourceMappingURL=validate-dto.cjs.map