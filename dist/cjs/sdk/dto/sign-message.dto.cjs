...
var sign_message_dto_exports = {};
__export(sign_message_dto_exports, {
  SignMessageDto: () => SignMessageDto
});
module.exports = __toCommonJS(sign_message_dto_exports);
...
*/
//# sourceMappingURL=sign-message.dto.cjs.map