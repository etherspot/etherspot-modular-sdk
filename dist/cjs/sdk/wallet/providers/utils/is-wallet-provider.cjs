...
var is_wallet_provider_exports = {};
__export(is_wallet_provider_exports, {
  isWalletProvider: () => isWalletProvider
});
module.exports = __toCommonJS(is_wallet_provider_exports);
...
//# sourceMappingURL=is-wallet-provider.cjs.map