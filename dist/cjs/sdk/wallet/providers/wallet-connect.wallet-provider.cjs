...
var wallet_connect_wallet_provider_exports = {};
__export(wallet_connect_wallet_provider_exports, {
  WalletConnectWalletProvider: () => WalletConnectWalletProvider
});
module.exports = __toCommonJS(wallet_connect_wallet_provider_exports);
...
*/
//# sourceMappingURL=wallet-connect.wallet-provider.cjs.map