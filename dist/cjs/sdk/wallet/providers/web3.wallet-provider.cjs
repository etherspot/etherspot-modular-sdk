...
var web3_wallet_provider_exports = {};
__export(web3_wallet_provider_exports, {
  Web3WalletProvider: () => Web3WalletProvider
});
module.exports = __toCommonJS(web3_wallet_provider_exports);
...
*/
//# sourceMappingURL=web3.wallet-provider.cjs.map