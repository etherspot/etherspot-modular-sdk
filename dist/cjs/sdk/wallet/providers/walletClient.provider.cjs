...
var walletClient_provider_exports = {};
__export(walletClient_provider_exports, {
  WalletClientProvider: () => WalletClientProvider
});
module.exports = __toCommonJS(walletClient_provider_exports);
...
*/
//# sourceMappingURL=walletClient.provider.cjs.map