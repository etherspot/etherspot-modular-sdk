...
var wallet_connect_2_wallet_provider_exports = {};
__export(wallet_connect_2_wallet_provider_exports, {
  WalletConnect2WalletProvider: () => WalletConnect2WalletProvider
});
module.exports = __toCommonJS(wallet_connect_2_wallet_provider_exports);
...
*/
//# sourceMappingURL=wallet-connect-2.wallet-provider.cjs.map