...
var dynamic_wallet_provider_exports = {};
__export(dynamic_wallet_provider_exports, {
  DynamicWalletProvider: () => DynamicWalletProvider
});
module.exports = __toCommonJS(dynamic_wallet_provider_exports);
...
*/
//# sourceMappingURL=dynamic.wallet-provider.cjs.map