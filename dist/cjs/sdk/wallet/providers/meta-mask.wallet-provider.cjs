...
var meta_mask_wallet_provider_exports = {};
__export(meta_mask_wallet_provider_exports, {
  MetaMaskWalletProvider: () => MetaMaskWalletProvider
});
module.exports = __toCommonJS(meta_mask_wallet_provider_exports);
...
*/
//# sourceMappingURL=meta-mask.wallet-provider.cjs.map