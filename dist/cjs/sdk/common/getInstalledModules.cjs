...
var getInstalledModules_exports = {};
__export(getInstalledModules_exports, {
  getInstalledModules: () => getInstalledModules,
  getModulesPaginated: () => getModulesPaginated
});
module.exports = __toCommonJS(getInstalledModules_exports);
...
*/
//# sourceMappingURL=getInstalledModules.cjs.map