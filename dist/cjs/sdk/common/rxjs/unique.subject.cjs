...
var unique_subject_exports = {};
__export(unique_subject_exports, {
  UniqueSubject: () => UniqueSubject
});
module.exports = __toCommonJS(unique_subject_exports);
...
// src/sdk/common/rxjs/unique.subject.ts
var UniqueSubject = class extends import_rxjs.BehaviorSubject {
...
*/
//# sourceMappingURL=unique.subject.cjs.map