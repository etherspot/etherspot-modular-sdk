...
var synchronized_subject_exports = {};
__export(synchronized_subject_exports, {
  SynchronizedSubject: () => SynchronizedSubject
});
module.exports = __toCommonJS(synchronized_subject_exports);
...
*/
//# sourceMappingURL=synchronized.subject.cjs.map