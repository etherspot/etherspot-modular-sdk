...
var transform_big_number_exports = {};
__export(transform_big_number_exports, {
  TransformBigNumber: () => TransformBigNumber
});
module.exports = __toCommonJS(transform_big_number_exports);
...
function TransformBigNumber() {
  return (0, import_class_transformer.Transform)((params) => {
    const { type, value } = params;
    let result = null;
    switch (type) {
      case import_class_transformer.TransformationType.PLAIN_TO_CLASS:
        result = value ? BigNumber.from(value) : null;
        break;
      case import_class_transformer.TransformationType.CLASS_TO_CLASS:
        result = value;
        break;
      case import_class_transformer.TransformationType.CLASS_TO_PLAIN:
...
*/
//# sourceMappingURL=transform-big-number.cjs.map