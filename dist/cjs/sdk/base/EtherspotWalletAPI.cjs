...
var EtherspotWalletAPI_exports = {};
__export(EtherspotWalletAPI_exports, {
  EtherspotWalletAPI: () => EtherspotWalletAPI
});
module.exports = __toCommonJS(EtherspotWalletAPI_exports);
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=EtherspotWalletAPI.cjs.map