...
var calcPreVerificationGas_exports = {};
__export(calcPreVerificationGas_exports, {
  DefaultGasOverheads: () => DefaultGasOverheads,
  calcPreVerificationGas: () => calcPreVerificationGas
});
module.exports = __toCommonJS(calcPreVerificationGas_exports);
...
*/
//# sourceMappingURL=calcPreVerificationGas.cjs.map