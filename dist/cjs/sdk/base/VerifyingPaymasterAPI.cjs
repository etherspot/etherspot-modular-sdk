...
var VerifyingPaymasterAPI_exports = {};
__export(VerifyingPaymasterAPI_exports, {
  VerifyingPaymasterAPI: () => VerifyingPaymasterAPI,
  getVerifyingPaymaster: () => getVerifyingPaymaster
});
module.exports = __toCommonJS(VerifyingPaymasterAPI_exports);
...
function assertTransactionEIP4844(transaction) {
  ...
  if (blobVersionedHashes) {
    ...
    for (const hash of blobVersionedHashes) {
      ...
      const version5 = hexToNumber(slice(hash, 0, 1));
      if (size_ !== 32)
...
*/
//# sourceMappingURL=VerifyingPaymasterAPI.cjs.map