...
var BaseAccountAPI_exports = {};
__export(BaseAccountAPI_exports, {
  BaseAccountAPI: () => BaseAccountAPI
});
module.exports = __toCommonJS(BaseAccountAPI_exports);
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=BaseAccountAPI.cjs.map