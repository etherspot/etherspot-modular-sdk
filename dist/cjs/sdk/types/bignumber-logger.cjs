...
var bignumber_logger_exports = {};
__export(bignumber_logger_exports, {
  ErrorCode: () => ErrorCode,
  LogLevel: () => LogLevel,
  Logger: () => Logger,
  version: () => version
});
module.exports = __toCommonJS(bignumber_logger_exports);
...
//# sourceMappingURL=bignumber-logger.cjs.map